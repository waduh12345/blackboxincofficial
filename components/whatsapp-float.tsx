...
export default function WhatsAppFloat() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-[9999] flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110 active:scale-95"
    >
      <svg
